...
/**
 * Request for retrieving profiling results.
 */
public class GetProfilingResultsRequest {

    private final String projectName;
    private final int limit;

    public GetProfilingResultsRequest(String projectName, int limit) {
    ...
    public static GetProfilingResultsRequest fromParameters(Map<String, Object> parameters) {
        if (parameters == null) {
            return new GetProfilingResultsRequest(null, 100);
        }
        ...
        return new GetProfilingResultsRequest(projectName, limit);
    }
